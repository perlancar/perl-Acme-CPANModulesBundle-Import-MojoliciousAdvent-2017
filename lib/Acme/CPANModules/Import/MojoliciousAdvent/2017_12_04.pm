...
our $LIST = {description=>"This list is generated by extracting module names mentioned in [https://mojolicious.io/blog/2017/12/04/day-4-dont-fear-the-full-app] (retrieved on 2018-12-30). Visit the URL for the full contents.",entries=>[{module=>"Mojolicious::Command::inflate"},{module=>"Mojolicious::Lite"}],summary=>"Modules mentioned in Mojolicious Advent Calendar 2017 (day 04)"};
